...
# NOTE: Now using SAME usernames as team accounts so posts show for team members
# Team accounts: natalia, colin, crystal (created by build.sh)
# Seed will create them if they don't exist, or reuse existing
friend_users = [
...
mock_posts = [
    ...
    # ========== nataliap (20 posts) ==========
    {'author': 'natalia', 'content': 'Beat the bread to the oven. Victory.', 'type': 'thoughts', 'days_ago': 1, **high_engagement()},
    {'author': 'natalia', 'content': 'Server cathedral. Prayers are HTTP requests.', 'type': 'media', 'days_ago': 4, 'media_url': MEDIA_URLS['server_cathedral'], **high_engagement()},
    {'author': 'natalia', 'content': 'Caramel hit 338°F exactly. Professional.', 'type': 'milestones', 'days_ago': 7, **high_engagement()},
    {'author': 'natalia', 'content': 'Backend work is ctrl+F and disappointment.', 'type': 'thoughts', 'days_ago': 12, **medium_engagement()},
    {'author': 'natalia', 'content': 'Lightning strike. Nature debugging itself.', 'type': 'media', 'days_ago': 18, 'media_url': MEDIA_URLS['lightning_strike'], **medium_engagement()},
    {'author': 'natalia', 'content': 'JWTs verified. Middleware gatekeeping works.', 'type': 'milestones', 'days_ago': 25, **high_engagement()},
    {'author': 'natalia', 'content': 'makemigrations. migrate. No errors. Suspicious.', 'type': 'thoughts', 'days_ago': 35, **medium_engagement()},
    {'author': 'natalia', 'content': 'Circuit board macro. Electron city.', 'type': 'media', 'days_ago': 45, 'media_url': MEDIA_URLS['motherboard_macro'], **low_engagement()},
    {'author': 'natalia', 'content': 'Sourdough starter survived the week.', 'type': 'milestones', 'days_ago': 55, **medium_engagement()},
    {'author': 'natalia', 'content': 'Django ORM is just SQL with extra steps.', 'type': 'thoughts', 'days_ago': 70, **high_engagement()},
    {'author': 'natalia', 'content': 'Fiber optics. Light running errands.', 'type': 'media', 'days_ago': 90, 'media_url': MEDIA_URLS['fiber_optic'], **medium_engagement()},
    {'author': 'natalia', 'content': 'First API deployed. It responds!', 'type': 'milestones', 'days_ago': 115, **high_engagement()},
    {'author': 'natalia', 'content': 'Print statements > debugger. Fight me.', 'type': 'thoughts', 'days_ago': 145, **low_engagement()},
    {'author': 'natalia', 'content': 'Volcano lava. Molten earth energy.', 'type': 'media', 'days_ago': 175, 'media_url': MEDIA_URLS['volcano_lava'], **high_engagement()},
    {'author': 'natalia', 'content': 'A year of gym consistency. Muscles exist.', 'type': 'milestones', 'days_ago': 210, **high_engagement()},
    {'author': 'natalia', 'content': 'Foreign keys are just trust issues in SQL.', 'type': 'thoughts', 'days_ago': 250, **medium_engagement()},
    {'author': 'natalia', 'content': 'Aurora cabin. Lonely but beautiful.', 'type': 'media', 'days_ago': 285, 'media_url': MEDIA_URLS['aurora_cabin'], **medium_engagement()},
    {'author': 'natalia', 'content': 'Learned Python basics. print("hello world")', 'type': 'milestones', 'days_ago': 320, **low_engagement()},
    {'author': 'natalia', 'content': 'Starting the coding journey. Nervous.', 'type': 'thoughts', 'days_ago': 350, **medium_engagement()},
    {'author': 'natalia', 'content': 'Signed up for bootcamp. Let\'s go.', 'type': 'milestones', 'days_ago': 362, **high_engagement()},

    # ========== colinw (22 posts) ==========
    {'author': 'colin', 'content':'Downtown and want to argue about shows?', 'type': 'thoughts', 'days_ago': 2, **high_engagement()},
    {'author': 'colin', 'content': 'Eclipse corona. The universe flexing hard.', 'type': 'media', 'days_ago': 4, 'media_url': MEDIA_URLS['eclipse_corona'], **high_engagement()},
    {'author': 'colin', 'content': 'Promoted to team lead! Leadership unlocked.', 'type': 'milestones', 'days_ago': 8, **high_engagement()},
    {'author': 'colin', 'content': 'The best code is code someone else can fix.', 'type': 'thoughts', 'days_ago': 15, **medium_engagement()},
    {'author': 'colin', 'content': 'Cyberpunk samurai meditation vibes.', 'type': 'media', 'days_ago': 22, 'media_url': MEDIA_URLS['meditation_mist'], **medium_engagement()},
    {'author': 'colin', 'content': 'First 1:1 as lead went well. Learning.', 'type': 'milestones', 'days_ago': 30, **medium_engagement()},
    {'author': 'colin', 'content': 'Simple solutions work but shouldn\'t look lazy.', 'type': 'thoughts', 'days_ago': 40, **high_engagement()},
    {'author': 'colin', 'content': 'Wudang mountains. Mist recommended.', 'type': 'media', 'days_ago': 52, 'media_url': MEDIA_URLS['wudang_mountains'], **low_engagement()},
    {'author': 'colin', 'content': 'Team shipped on time. First time ever.', 'type': 'milestones', 'days_ago': 65, **high_engagement()},
    {'author': 'colin', 'content': 'Meetings could have been emails. All of them.', 'type': 'thoughts', 'days_ago': 80, **medium_engagement()},
    {'author': 'colin', 'content': 'Akihabara sensory assault. Electric Town.', 'type': 'media', 'days_ago': 95, 'media_url': MEDIA_URLS['akihabara'], **high_engagement()},
    {'author': 'colin', 'content': 'Half-marathon complete! 13.1 miles down.', 'type': 'milestones', 'days_ago': 115, **high_engagement()},
    {'author': 'colin', 'content': 'Code review is just reading someone\'s diary.', 'type': 'thoughts', 'days_ago': 140, **medium_engagement()},
    {'author': 'colin', 'content': 'Shanghai fog. Pudong through mist.', 'type': 'media', 'days_ago': 165, 'media_url': MEDIA_URLS['shanghai_fog'], **medium_engagement()},
    {'author': 'colin', 'content': 'Got the job offer! Celebrating tonight.', 'type': 'milestones', 'days_ago': 195, **high_engagement()},
    {'author': 'colin', 'content': 'Agile is just organized chaos with sticky notes.', 'type': 'thoughts', 'days_ago': 225, **low_engagement()},
    {'author': 'colin', 'content': 'Aurora mountain view. Worth the cold.', 'type': 'media', 'days_ago': 255, 'media_url': MEDIA_URLS['aurora_mountain'], **high_engagement()},
    {'author': 'colin', 'content': 'Seagull stole my burrito. Respect. Fear.', 'type': 'milestones', 'days_ago': 285, **medium_engagement()},
    {'author': 'colin', 'content': 'Starting new role next week. Nervous energy.', 'type': 'thoughts', 'days_ago': 315, **medium_engagement()},
    {'author': 'colin', 'content': 'Bamboo forest. Wind sounds like breathing.', 'type': 'media', 'days_ago': 340, 'media_url': MEDIA_URLS['bamboo_forest'], **low_engagement()},
    {'author': 'colin', 'content': 'Completed the interview gauntlet. Exhausted.', 'type': 'milestones', 'days_ago': 358, **high_engagement()},
    {'author': 'colin', 'content': 'First day at bootcamp. Everything is new.', 'type': 'thoughts', 'days_ago': 363, **medium_engagement()},

    # ========== crystalr (20 posts) ==========
    {'author': 'crystal', 'content': 'Rest day. Body said no. I said fair.', 'type': 'thoughts', 'days_ago': 0, **high_engagement()},
    {'author': 'crystal', 'content': 'Osaka at night. Sensory overload philosophy.', 'type': 'media', 'days_ago': 3, 'media_url': MEDIA_URLS['osaka_nights'], **high_engagement()},
    {'author': 'crystal', 'content': 'Broke 20 minutes on the 5k. Legs outvoted.', 'type': 'milestones', 'days_ago': 6, **high_engagement()},
    {'author': 'crystal', 'content': 'Moved a div 2 pixels. Stared. Moved it back.', 'type': 'thoughts', 'days_ago': 11, **medium_engagement()},
    {'author': 'crystal', 'content': 'Seoul neon reflections. Every surface a screen.', 'type': 'media', 'days_ago': 18, 'media_url': MEDIA_URLS['seoul_glow'], **medium_engagement()},
    {'author': 'crystal', 'content': 'Friend requests working! Accept, decline, block.', 'type': 'milestones', 'days_ago': 28, **high_engagement()},
    {'author': 'crystal', 'content': 'Copilot assisted. So did caffeine and spite.', 'type': 'thoughts', 'days_ago': 40, **medium_engagement()},
    {'author': 'crystal', 'content': 'Fiber optics. Light trapped running errands.', 'type': 'media', 'days_ago': 55, 'media_url': MEDIA_URLS['fiber_optic'], **low_engagement()},
    {'author': 'crystal', 'content': 'First PR merged. Code is in production!', 'type': 'milestones', 'days_ago': 70, **high_engagement()},
    {'author': 'crystal', 'content': 'CSS grid finally makes sense. Only took a week.', 'type': 'thoughts', 'days_ago': 90, **high_engagement()},
    {'author': 'crystal', 'content': 'Aurora spiral overhead. Corona magic.', 'type': 'media', 'days_ago': 110, 'media_url': MEDIA_URLS['aurora_spiral'], **medium_engagement()},
    {'author': 'crystal', 'content': 'Month 1: Hello World. Month 6: deployed app.', 'type': 'milestones', 'days_ago': 135, **high_engagement()},
    {'author': 'crystal', 'content': 'Flexbox is just CSS doing yoga.', 'type': 'thoughts', 'days_ago': 165, **medium_engagement()},
    {'author': 'crystal', 'content': 'Rare blood-red aurora. Worth the wait.', 'type': 'media', 'days_ago': 195, 'media_url': MEDIA_URLS['aurora_red'], **high_engagement()},
    {'author': 'crystal', 'content': 'First website live! Can click things!', 'type': 'milestones', 'days_ago': 230, **high_engagement()},
    {'author': 'crystal', 'content': 'Semicolons are just decorative at this point.', 'type': 'thoughts', 'days_ago': 265, **low_engagement()},
    {'author': 'crystal', 'content': 'Bioluminescence waves. Ocean glowing.', 'type': 'media', 'days_ago': 295, 'media_url': MEDIA_URLS['bioluminescence'], **medium_engagement()},
    {'author': 'crystal', 'content': 'Wrote first line of JavaScript. alert("hi")', 'type': 'milestones', 'days_ago': 325, **medium_engagement()},
    {'author': 'crystal', 'content': 'Learning to code. Everything is confusing.', 'type': 'thoughts', 'days_ago': 350, **low_engagement()},
    {'author': 'crystal', 'content': 'Day 1 of the journey. Let\'s see.', 'type': 'milestones', 'days_ago': 364, **medium_engagement()},
