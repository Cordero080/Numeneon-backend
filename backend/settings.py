...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-sa1rw_z^6lt3*pjyi##o_$mcm%wo&uq!=h@$2=j1n!lsq_^rr*')
...
if DEBUG:
    ALLOWED_HOSTS.extend(['localhost', '127.0.0.1'])  # Allow localhost in dev
